		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			*/
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				if ( in_array( 'current-menu-item', $classes, true ) || ( is_singular('job-offer') && in_array('page-item-'._page_template_id('career'), $classes) ) ) {
					$class_names .= ' active';
				}
				if ( in_array( 'current-menu-item', $classes, true ) || ( is_tax('services-groups') && in_array('page-item-'._page_template_id('offer'), $classes) ) ) {
					$class_names .= ' active';
				}
				if ( in_array( 'current-menu-item', $classes, true ) || ( is_singular('doctor') && in_array('page-item-'._page_template_id('doctors'), $classes) ) ) {
					$class_names .= ' active';
				}
