...
<?php if( $content_type == 'custom' ) : ?>
  ...
  <?php 
  $custom_content = get_field('_widget_posts_carousel_custom_content', $widget_id); 
  $center_content = get_field('_widget_posts_custom_content_center', $widget_id);
  ?>

  <?php if( $custom_content ) : ?>
  <div class="container">
    <div class="wiget-item widget-posts-carousel">
      <?php echo RFS_WIDGETS::widget_header_by_style($header, $header_style, false, true); ?>

      <div class="widget-pb-posts widget-carousel-posts owl-carousel">
        <?php foreach($custom_content as $item) : ?>
          <?php 
...
<?php else : ?>
  ...
  <?php if( $posts_type == 'services-groups' ) : ?>
    ...
    <?php $terms = RFS_WIDGETS::get_widget_terms( $widget_id, $posts_type, 10, $custom_posts ); ?>
  ...
  <?php else : ?>
    ...
    <?php $posts = RFS_WIDGETS::get_widget_posts( $widget_id, $posts_type, 10, $custom_posts ); ?>
