...
<html>
	...
	<title><?php _e('New order', 'rfswp'); ?></title>
	<?php echo $styles; ?>
	</head>
	<body class="">
			...
			<td class="container">
				...
				<span class="preheader">
					<?php if( $send_to == 'admin' ) : ?>
						<?php _e('You have received a new order', 'rfswp'); ?>
					<?php else : ?>
						<?php _e('Your order has been received and is now being processed', 'rfswp'); ?>
					<?php endif; ?>
				</span>
				<table class="main">
					...
					<td class="wrapper">
						...
						<?php endif; ?>
						<?php if( $payment_method == 'transfer' && $send_to == 'customer' ) : ?>
							<?php $info = get_field('_transfer_email_info', 'option'); ?>
							<tr>
								<td>
									<?php if( !_empty_content( $info) ) : ?><br><?php echo $info; ?><?php endif; ?>
								</td>
							</tr>
						<?php endif; ?>
						<?php if( $payment_method == 'online' && $send_to == 'customer' ) : ?>
							<?php $info = get_field('_tpay_email_info', 'option'); ?>
							<tr>
								<td>
									<?php if( !_empty_content( $info) ) : ?><br><?php echo $info; ?><?php endif; ?>
								</td>
